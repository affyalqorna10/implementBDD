...
WebUI.uploadFile(findTestObject('Object Repository/Edit Profile Picture/uploadFile'), RunConfiguration.getProjectDir() + 
    '/keyboard.jpg')

//WebUI.click(findTestObject('Object Repository/Edit Profile Picture/i_Change Profile Picture_oxd-icon bi-plus'))
